...
The `daoh` package implements the methodological framework described in
Cumin et al. [PAPER TO COME] for calculating
...
This example reproduces the worked example from Figure 1 of the paper:
...
Based on Cumin et al. we recommend:
